  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "stmt": parse_stmt,
        "globaloption": parse_globaloption,
      ...
      function parse_graph() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, type, name, statements) {
          	return { type : type.toLowerCase(), name:name, statements:statements }
          })(pos0, result0[3], result0[4], result0[7]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_subgraph() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, statements) {
      ...
      function parse_stmt_list() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, head, tail) { return buildList(head,tail,1) })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_edge_stmt() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, v, tl, a) { 
           	if( a === null ){
          		a = []
          	}
      ...
      function parse_edgeRHS() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, tl) {return tl})(pos3, result2);
            }
            if (result2 === null) {
              pos = pos3;
            }
        ...
        if (result0 !== null) {
          result0 = (function(offset, a, v, more) {
         	return [a,v].concat(more||[]) })(pos1, result0[0], result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos1;
        }
      ...
      function parse_node_stmt() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, a) { 
          	if( a === null ){
          		a = {}
          	}
      ...
      function parse_a_list() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, k, v, tl) { 
        	if( v === null ){ v = 1 }
        	else{ v = v[2] }
        	var r = [[k,v]]
        	if( tl ) r = r.concat( tl )
        	return r
          })(pos0, result0[0], result0[1], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_GRAPHTYPE() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            if (input.substr(pos, 3).toLowerCase() === "dag") {
            ...
            if (result0 === null) {
              if (input.substr(pos, 3).toLowerCase() === "mag") {
                result0 = input.substr(pos, 3);
                pos += 3;
              } else {
                result0 = null;
              ...
              if (result0 === null) {
                if (input.substr(pos, 4).toLowerCase() === "pdag") {
                ...
                if (result0 === null) {
                  if (input.substr(pos, 3).toLowerCase() === "pag") {
                    result0 = input.substr(pos, 3);
                    pos += 3;
                  } else {
                    result0 = null;
      ...
      function parse_BAREWORD() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, m, id) { return (m===null?'':'-') + id.join('') })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_STRING() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            ...
            if (result1 !== null) {
              result1 = (function(offset, v) {return v})(pos2, result1[2]);
            }
            if (result1 === null) {
              pos = pos2;
            }
          ...
          if (result0 !== null) {
            result0 = (function(offset, v, rest) { return rest === null ? v[1] : (v[1] + rest); })(pos0, result0[0], result0[1]);
          }
          if (result0 === null) {
            pos = pos0;
          }
